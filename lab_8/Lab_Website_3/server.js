...
app.get('/home/pick_color', function(req, res) {
    ...
    .then(info => {
    	res.render('pages/home',{
				my_title: "Home Page",
				data: info,// Return the color options
...
app.post('/home/pick_color', function(req, res) {
    ...
    .then(info => {
    	res.render('pages/home',{
				my_title: "Home Page",
				data: info,// Return the color choices
...
app.get('/team_stats', function(req, res) {
	var query = 'select * from football_games;'; // Retreive
	var wins = 'SELECT COUNT(*) FROM football_games WHERE home_score > visitor_score;' // Calculate winning games
	var losses = 'SELECT COUNT(*) FROM football_games WHERE home_score < visitor_score'; // Calculate losing games
	db.task('get-everything', task => {
		return task.batch([
			task.any(query),
			task.any(wins),
...
app.get('/player_info/post', function(req, res) {
	var get_id = req.query.player_choice;
	var query = 'select id,name from football_players;';
	var player_info = 'select * from football_players where id=' + get_id + ';';
	// var games_player = 'select count(*) from football_players inner join football_games on football_players.id = ANY(football_games.players);' // Query not correct
	db.task('get-everything', task => {
		return task.batch([
			task.any(query),
